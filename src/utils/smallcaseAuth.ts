...
export function verifyAuthToken(token: string, secret: string): JWTVerificationResult {
  try {
...
export const SmallcaseConfig = {
  ...
  demo: {
    ...
    demoConnectedToken:
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzbWFsbGNhc2VBdXRoSWQiOiI2MzFmYWQwMWQ5ZmU3YmEzNGI2YzBhM2EiLCJleHAiOjE5MDAwMDAwMDB9.-_6ykYyKke4xuKImlYEPTX9fJhLoMU86qMHRX0YY6eA',
    // Demo guest token
    demoGuestToken:
